...
* https://www.netapp.com/us/media/ds-3896.pdf["Fiche technique Converged Systems Advisor"^]
+
Pour en savoir plus sur les avantages offerts par Converged Systems Advisor.

* https://www.netapp.com/us/media/tr-4036.pdf["Rapport technique NetApp 4036 : spécifications techniques des data centers FlexPod"^]
+
